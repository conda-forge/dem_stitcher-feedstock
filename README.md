...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dem_stitcher-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dem_stitcher-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install dem_stitcher
```
...
It is possible to list all of the versions of `dem_stitcher` available on your platform:
...
```
pixi search dem_stitcher --channel conda-forge
```
